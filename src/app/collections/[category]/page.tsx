...
const footwearProducts: Product[] = [
    ...
    { id: 'fw10', name: 'Gravity-Grip Hikers', price: 319.99, image: 'https://images.unsplash.com/photo-1520211601693-0c634biny69?q=80&w=1964&auto=format&fit=crop', category: 'Footwear', rating: 5, stock: 28, description: 'Hiking boots with electro-adhesive soles for superior grip.', data_ai_hint: 'hiking boots' },
...
const accessoriesProducts: Product[] = [
    ...
    { id: 'ac5', name: 'Stealth-Wallet', price: 159.99, image: 'https://images.unsplash.com/photo-1620923984931-140a359a6a8a?q=80&w=2070&auto=format&fit=crop', category: 'Accessories', rating: 5, stock: 50, description: 'A slim, RFID-blocking wallet with a biometric lock.', data_ai_hint: 'slim wallet' },
...
const collectionsData: Record<string, { name: string; products: Product[] }> = {
  'apparel': { name: 'Apparel', products: apparelProducts },
  'footwear': { name: 'Footwear', products: footwearProducts },
  'electronics': { name: 'Electronics', products: electronicsProducts },
  'accessories': { name: 'Accessories', products: accessoriesProducts },
  'home goods': { name: 'Home Goods', products: homeGoodsProducts },
};
...
export default async function CollectionPage({ params }: CollectionPageProps) {
  ...
  const collectionInfo = collectionsData[categoryKey];

  if (!collectionInfo) {
    notFound();
  }

  const { name: displayCategoryName, products } = collectionInfo;
