      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {collections.map(collection => (
            ...
            <Link href={collection.href} key={collection.name} className="group relative block overflow-hidden rounded-lg">
              <Image src={collection.image} width={400} height={500} alt={collection.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" data-ai-hint={collection.data_ai_hint} />
